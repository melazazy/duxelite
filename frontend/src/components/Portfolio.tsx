    ...
    <section id="portfolio" className="py-20 bg-gradient-to-br from-[#0A2540] via-[#0A2540] to-[#1a4a6e] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <Link to="/projects" className="inline-flex items-center bg-gradient-to-r from-[#00CFFF] to-[#0A2540] text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105">
            View All Projects
