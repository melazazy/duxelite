...
const Testimonials: React.FC = () => {
  ...
  if (loading) {
    return (
      <section id="testimonials" className="py-20 bg-gradient-to-b from-[#0A2540] to-[#030D18] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg text-white/70">Loading testimonials...</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section id="testimonials" className="py-12 md:py-16 bg-gradient-to-b from-[#0A2540] to-[#030D18] text-white">
        ...
        >
          {testimonials.map((testimonial, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white/5 p-6 md:p-8 rounded-xl text-center max-w-2xl mx-auto border border-white/10 backdrop-blur-sm">
